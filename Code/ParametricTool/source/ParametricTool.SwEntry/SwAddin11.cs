...
{
    /// <summary>
    /// Summary description for ParametricTool.SwEntry.
    /// </summary>
    [Guid("33b292c7-2131-4daa-a8ee-fdc55a36a975"), ComVisible(true)]
    [SwAddin(
        Description = "ParametricTool.SwEntry description",
        Title = "ParametricTool.SwEntry",
        LoadAtStartup = true
        )]
    public class SwAddin11 : ISwAddin
    {
